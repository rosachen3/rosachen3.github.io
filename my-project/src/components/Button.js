export default function Button({
    ...
    return(
        <div className={`${text==="Let's Connect" ? "hidden md:inline-block" : ""}`}>
            <button onClick={clickHandler} className={`flex gap-2 md:gap-4 ${bgColour} ${borderColour} border-2 font-semibold text-sm ${padding} lg:text-lg rounded-2xl ${textColour} items-center`}>
